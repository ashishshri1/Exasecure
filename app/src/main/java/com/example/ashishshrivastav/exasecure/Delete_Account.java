...
public class Delete_Account extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(Delete_Account.this,android.R.layout.simple_list_item_1,names);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db1.execSQL("delete from account where id=? and name=?",new String[]{Integer.toString(id),text});
                db1.close();
                Toast toast = Toast.makeText(getApplicationContext(), "Account Deleted", Toast.LENGTH_SHORT);
                toast.show();
                Intent intent=new Intent(Delete_Account.this,Portal.class);
